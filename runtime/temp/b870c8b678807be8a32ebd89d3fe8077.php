<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"D:\wamp\www\wdata/app/admin\view\data\edit_data.php";i:1514435756;s:43:"D:\wamp\www\wdata/app/admin\view\layout.php";i:1510139904;s:49:"D:\wamp\www\wdata/app/admin\view\block\header.php";i:1510139904;s:49:"D:\wamp\www\wdata/app/admin\view\block\footer.php";i:1510139904;}*/ ?>
...
<form class="layui-form layui-form-pane" action="<?php echo url(); ?>"  method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="type1" class="field-role_id" type="select">
                <option value="ch_data" <?php if($data_info['type1'] == 'ch_data'): ?>selected=""<?php endif; ?>>中文数据库</option>
                <option value="en_data" <?php if($data_info['type1'] == 'en_data'): ?>selected=""<?php endif; ?> >英文数据库</option>
                <option value="doc_data"  <?php if($data_info['type1'] == 'doc_data'): ?>selected=""<?php endif; ?>>医学数据库</option>
                <option value="law_data" <?php if($data_info['type1'] == 'law_data'): ?>selected=""<?php endif; ?> >法律数据库</option>
                <option value="ec_data"  <?php if($data_info['type1'] == 'ec_data'): ?>selected=""<?php endif; ?>>经济数据库</option>
            </select>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="type" class="field-role_id" type="select">
                <option value="1" <?php if($data_info['type'] == '1'): ?>selected=""<?php endif; ?>>username&password</option>
                <option value="2" <?php if($data_info['type'] == '2'): ?>selected=""<?php endif; ?> >user&pass</option>
                <option value="3"  <?php if($data_info['type'] == '3'): ?>selected=""<?php endif; ?>>在一起</option>
            </select>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username"  value="<?php echo $data_info['loginurl']; ?>" name="loginurl" lay-verify="title" autocomplete="off" placeholder="请输入登录地址">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username"  value="<?php echo $data_info['webdoor']; ?>" name="webdoor" lay-verify="title" autocomplete="off" placeholder="请输入登录地址">
        </div>
        <div class="layui-form-mid layui-word-aux">表单操作提示</div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-nick"  value="<?php echo $data_info['username']; ?>" name="username" lay-verify="title" autocomplete="off" placeholder="请输入用户名">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">登陆密码</label>
        <div class="layui-input-inline">
            <input type="password" class="layui-input" name="password"  value="<?php echo $data_info['password']; ?>"  lay-verify="password" autocomplete="off" placeholder="******">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-nick"  value="<?php echo $data_info['type2']; ?>" name="type2" lay-verify="title" autocomplete="off" placeholder="请输入用户名">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-nick"  value="<?php echo $data_info['min_typename']; ?>" name="min_typename" lay-verify="title" autocomplete="off" placeholder="请输入用户名">
        </div>
    </div>

    <div class="layui-form-item">
        <div class="layui-input-block">
            <input type="hidden" class="field-id" name="id" value="<?php echo $data_info['id']; ?>">
