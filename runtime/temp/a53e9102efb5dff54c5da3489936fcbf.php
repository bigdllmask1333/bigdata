<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"D:\wamp\www\wdata/app/admin\view\user\info.php";i:1515814208;s:43:"D:\wamp\www\wdata/app/admin\view\layout.php";i:1510139904;s:49:"D:\wamp\www\wdata/app/admin\view\block\header.php";i:1510139904;s:49:"D:\wamp\www\wdata/app/admin\view\block\footer.php";i:1514879062;}*/ ?>
...
<div class="page-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 390px;">
            <input style="width: auto" type="text" class="layui-input field-username" readonly="readonly" name="username" lay-verify="required" autocomplete="off" placeholder="请输入用户名" readonly="">
            <span style="float: right;color:red;margin-top: -30px" >* 用户名一旦注册不允许更改！</span>
        </div>
    </div>
    <div class="layui-form-item">
