<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"D:\wamp\www\wdata/app/admin\view\publics\index.php";i:1515827097;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class='login'>
    ...
    <div class='login_fields'>
        ...
        <div class='login_fields__password'>
            ...
            <div id="shauxin"><?php echo token('__token__', 'sha1'); ?></div>
        </div>
        ...
        $('input[type="button"]').click(function () {
            ...
            if (username == '') {
                ...
                $.ajax({
                    ...
                    //提交的网址
                    // url:url,
                    url: "<?php echo url('/admin/Publics'); ?>", //orderModifyStatus
                    //提交的数据
                    data:JsonData,
                    dataType:"json",
                    async:false,
